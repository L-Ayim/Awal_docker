...
function buildEvidencePayload(
  ...
  return [
    ...
    "- For risky actions involving sensitive, internal, regulated, confidential, customer, financial, or proprietary data, do not say allowed, permitted, okay, or safe unless the evidence explicitly grants permission. If the evidence only provides controls, prohibitions, approvals, or broader handling rules, say the action is not explicitly allowed by the retrieved evidence and explain the relevant controls or approval path.",
    "- For advice or decision questions, include what the user should do next only when the evidence supports it.",
    "- For broad summary questions such as main controls, key safeguards, or ways to protect information, synthesize across all directly relevant evidence candidates. Do not require the exact phrase from the question if the evidence clearly describes controls, safeguards, requirements, or protective measures.",
...
function buildAnswerVerificationPayload(params: {
  ...
  return [
    ...
    "- For risky actions involving sensitive, internal, regulated, confidential, customer, financial, or proprietary data, downgrade any unsupported 'allowed', 'permitted', 'okay', or 'safe' wording to a conservative supported posture such as not explicitly allowed, requires approval, or must follow the documented controls.",
    "- For broad summary questions such as main controls, key safeguards, or ways to protect information, preserve a grounded answer when multiple evidence candidates directly describe relevant controls or safeguards, even if no single evidence candidate uses the exact phrase in the question.",
